package com.dieyidezui.capt.plugin.dsl;
...
public class CaptPluginExtension extends GroovyObjectSupport implements Named {
    ...
    public CaptPluginExtension(String name) {
        this.name = name;
    }
